...
parser.add_argument('--model', type=str, default='ResNet32', help='Model type')
...
parser.add_argument('--lamda', type=float, default=1, help='Ratio')

parser.add_argument('--interval', type=int, default=100, help='Interval')
parser.add_argument('--save_model', type=str, default='./output/teacher/', help='Path to save model')
...
for epoch in range(args.epochs):
    ...
    if args.save_model:
        ...
        torch.save(
            ...
            os.path.join(args.save_model, 'teacher.pth')
        )
